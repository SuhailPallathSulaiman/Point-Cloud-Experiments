...
main (int argc, char** argv)
{
  ...
  if (pcl::io::loadPCDFile<pcl::PointXYZRGB> ("Cup_unfiltered/inputCloud15.pcd", *input_cloud) == -1)
  {
  ...
  pass1.setFilterLimits (-0.1, 0.2);
  //pass.setFilterLimitsNegative (true);
  pass1.filter (*cloud_filtered);

  // Saving transformed input cloud.
  pcl::io::savePCDFileASCII ("Cup/cup15.pcd", *cloud_filtered);

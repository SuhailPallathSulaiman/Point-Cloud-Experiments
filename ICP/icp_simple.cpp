...
main (int argc, char** argv)
{
  ...
  if (pcl::io::loadPCDFile<pcl::PointXYZRGB> ("final.pcd", *Out) == -1)
  {
  ...
  if (pcl::io::loadPCDFile<pcl::PointXYZRGB> ("Cup/cup1.pcd", *cloud1) == -1)
  {
    PCL_ERROR ("Couldn't read  \n");
    return (-1);
  }
  ...
  if (pcl::io::loadPCDFile<pcl::PointXYZRGB> ("Cup/cup2.pcd", *cloud2) == -1)
  {
    PCL_ERROR ("Couldn't read  \n");
    return (-1);
  }
